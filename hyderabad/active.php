...
try {
    ...
    $mail->Username = 'homexrepir@gmail.com';                 // SMTP username
...
<p class = 'paragraph1'>HELLO! Welcome to sabiduria. A site where you can enhance your wisdom (sabiduria).</p>
